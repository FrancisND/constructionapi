...
namespace BusinessLayer.Services
{
    public class CompanyService : ICompanyService
    {
        ...
        public async Task<bool> UpdateCompanyAsync(string companyCode, CompanyInfo company)
        {
            return await _companyRepository.UpdateCompanyAsync(companyCode, _mapper.Map<Company>(company));
        }
